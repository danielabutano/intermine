...
public class WebInitializer extends SpringBootServletInitializer {
    ...
    private void initBlockingErrors(ServletContext servletContext) {
        ...
        servletContext.setAttribute(Constants.INITIALISER_KEY_ERROR, blockingErrorKeys);
    }
    ...
    private ClassKeys loadClassKeys(Model model) {
        ...
        try {
            classKeyProps.load(WebInitializer.class.getClassLoader()
    ...
    private Properties loadWebProperties(ServletContext servletContext) {
        ...
        servletContext.setAttribute(Constants.WEB_PROPERTIES, trimProperties);
